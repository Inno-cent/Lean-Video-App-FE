<template>
  <div class="landing--page--container">
    ...
    <div class="section">
      <div class="explore--container">
        ...
        <p class="landing--subtext">
          ...
          high-definition quality, secure <br />
          communication, and intuitive design for seamless connections
        </p>
      </div>
    ...
    <div class="section">
      <div class="testimony--main--container">
        <div class="testimony--inner--wrapper">
          <div class="explore--container">
            ...
            <div class="text-container">
              <p class="testimony--text">
                <q class="quote--marks">
                  ...
                  video quality is consistently outstanding,...
                </q>
              </p>
